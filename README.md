...
- **Local multilingual readings.** Mandarin Pinyin, Cantonese Jyutping, Japanese romaji and furigana, Korean reading modes, and Russian or Ukrainian romanization are available. Mixed Chinese and Japanese tracks are routed line by line. Provider-authored Japanese hints such as `天(そら)` become distinct furigana and romaji accents without changing the source lyric or timing.
